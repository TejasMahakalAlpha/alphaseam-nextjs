...
const CareerPage: React.FC = () => {
  ...
  // NOTE: These functions are currently unused because there are no job openings.
  // They will be needed once you add jobs to the 'dummyCareers' array.
