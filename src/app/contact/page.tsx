...
import {
  FaLinkedinIn, FaMapMarkerAlt, FaPhoneAlt, FaEnvelope,
  ...
  return (
    <div className={styles['contact-page']}>
      <Head>
        ...
        <meta name="description" content="Get in touch with Alphaseam for inquiries, support, or to discuss your next project." />
      </Head>
      ...
      <section className={styles['contact-hero-section']} data-aos="fade-in">
        <h1>Get In Touch</h1>
        <p>We're here to answer any question you might have. We look forward to hearing from you.</p>
      </section>

      <main className={styles['contact-content-wrapper']}>
        <div className={styles['contact-grid']}>
          <article className={styles['contact-details-card']} data-aos="fade-right">
            <h3>Contact Information</h3>
            <p>Fill up the form and our team will get back to you within 24 hours.</p>
            <ul>
              <li><FaPhoneAlt className={styles['contact-icon']} /> <a href="tel:+917387182811">+91-7387182811</a></li>
              <li><FaEnvelope className={styles['contact-icon']} /> <a href="mailto:info@alphaseam.com">info@alphaseam.com</a></li>
              <li><FaMapMarkerAlt className={styles['contact-icon']} /> <span>City Centre, Hinjawadi, Pune</span></li>
            </ul>
            <div className={styles['social-icons-wrapper']}>
              <a href="https://www.linkedin.com/company/alphaseam-enterprises-llp/" target="_blank" rel="noopener noreferrer" className={styles['social-icon']} aria-label="LinkedIn"><FaLinkedinIn /></a>
            </div>
          </article>

          <div className={styles['contact-form-card']} ref={contactFormRef} data-aos="fade-left">
            <form onSubmit={handleSubmit} className={styles['contact-form-content']} noValidate>
      ...
      <section className={styles['map-section']} data-aos="fade-up" data-aos-delay="300">
        <iframe
