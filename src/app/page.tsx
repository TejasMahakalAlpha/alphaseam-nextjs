...
const services = [
  {
    ...
    desc: "Enterprise-grade ERP implementations to modernize and scale your core operations.",
    icon: <PlusIcon />,
  },
  {
    img: service2,
    title: "Custom Development",
    desc: "Intelligent, tailor-made web and mobile applications that solve unique business challenges.",
    icon: <PlusIcon />,
  },
  {
    img: service3,
    title: "System Integration",
    desc: "Synchronizing disparate systems to create a seamless, optimized technology ecosystem.",
    icon: <PlusIcon />,
  },
];
...
const caseStudies = [
  {
    ...
    desc: "Implemented a full-scale SAP S/4HANA transformation across 25+ countries, unifying global operations.",
    category: "SAP S/4HANA",
  },
  {
    img: case2,
    title: "High-Availability FinTech API",
    desc: "Engineered a scalable, secure, API-driven architecture achieving 99.99% uptime for a leading FinTech.",
    category: "API Architecture",
  },
  {
    img: case3,
    title: "Logistics Network Integration",
    desc: "Orchestrated a complex system integration across 10+ smart warehouses, boosting efficiency by 40%.",
